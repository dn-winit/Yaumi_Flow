...
const variantClasses: Record<CardVariant, string> = {
  default: "bg-surface-raised rounded-xl shadow-1 p-5",
  flat: "bg-surface-raised rounded-xl p-5",
  gradient: "bg-gradient-to-r from-brand-50 to-info-50 rounded-xl border border-brand-100 p-5",
};
